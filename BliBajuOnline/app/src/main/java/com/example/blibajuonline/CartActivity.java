...
import com.example.blibajuonline.Model.Cart;
import com.example.blibajuonline.Model.Products;
import com.example.blibajuonline.Prevalent.Prevalent;
import com.example.blibajuonline.ViewHolder.CartViewHolder;
...
public class CartActivity extends AppCompatActivity
{
    ...
    protected void onStart()
    {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter
            ...
            {
                holder.txtProductQuantity.setText("Kuantiitas bahan    : "+ model.getQuantity());
                holder.txtProductPrice.setText("Harga Barang    : Rp. "+ model.getPrice() + ",- /pcs");
